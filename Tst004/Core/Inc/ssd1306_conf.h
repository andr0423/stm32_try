...
// SPI Configuration
#define SSD1306_SPI_PORT        hspi5
// 
// | PA5 | SPI6_SCK  | blue    | grey   | CLK |
// | PB5 | SPI6_MOSI | red     | purple | DIN |
// |     | spi6 cs   | black   | grey   | CS  | OLED_CS_Pin
// | PA4 | spi6 dc   | white   | white  | D/C | OLED_DC_Pin
// | PB4 | spi6 res  | l.black | black  | RES | OLED_Res_Pin
//
